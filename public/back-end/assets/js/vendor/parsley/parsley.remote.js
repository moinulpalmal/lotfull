...
window.ParsleyExtend = $.extend(window.ParsleyExtend, {
  ...
  _remote: function (deferred) {
    ...
    // Generate location key based on ajax options
  ...
  */
  ...
  ParsleyUI.prototype = {
    ...
    reflow: function (fieldInstance) {
      ...
      // Then location current validation result for next reflow
    ...
    setupField: function (fieldInstance) {
      ...
      /** Generate important UI elements and location them in fieldInstance **/
