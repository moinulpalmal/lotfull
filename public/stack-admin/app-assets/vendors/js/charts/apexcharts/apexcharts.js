...
(function (global, factory) {
    ...
    _createClass(Globals, [{
      ...
      value: function globalVars(config) {
        return {
          ...
          initialConfig: null,
          // we will location the first config user has set to go back when user finishes interactions like zooming and come out of it
          lastXAxis: [],
          lastYAxis: [],
          series: [],
          ...
          stackedSeriesTotals: [],
          seriesX: [],
          // location the numeric x values in this array (x values)
          seriesZ: [],
          // The 3rd "Z" dimension for bubbles chart (z values)
          labels: [],
          // location the text to draw on x axis
          // Don't mutate the labels, many things including tooltips depends on it!
          timelineLabels: [],
          // location the timeline Labels in another variable
          ...
          pointsArray: [],
          // location the points positions here to draw later on hover
          // format is - [[x,y],[x,y]... [x,y]]
          dataLabelsRects: [],
          // location the positions of datalabels to prevent collision
    ...
    _createClass(Range$$1, [{
      ...
      value: function setXRange() {
        ...
        if ((gl.isXNumeric || gl.noLabelsProvided) && (!cnf.xaxis.convertedCatToNumeric || gl.dataFormatXNumeric)) {
          ...
          } // we will still location these labels as the count for this will be different (to draw grid and labels placement)
  ...
  function () {
    ...
    _createClass(Dimensions, [{
      ...
      value: function setGridCoordsForAxisCharts(lgRect) {
        ...
        w.config.yaxis.map(function (yaxe, index) {
          // location the labels and titles coords in global vars
  ...
  function () {
    function Core(el, ctx) {
      ...
      this.threeDSeries = [];
      this.twoDSeriesX = [];
    } // get data and location into appropriate vars
      ...
      value: function DOMHandling(_ref4) {
        ...
        if (ttCtx.showTooltipTitle) {
          if (ttCtx.tooltipTitle === null) {
            // get it once if null, and location it in class property
    ...
    _createClass(ZoomPanSelection, [{
      ...
      value: function selectionDrawn(_ref4) {
        ...
        if (me.dragged && (me.dragX > 10 || me.dragY > 10) && xLowestValue !== xHighestValue) {
          if (w.globals.zoomEnabled) {
            var yaxis = Utils.clone(w.config.yaxis); // before zooming in/out, location the last yaxis and xaxis range, so that when user hits the RESET button, we get the original range
            // also - make sure user is not already zoomed in/out - otherwise we will location zoomed values in lastAxis
  ...
  (function (root, factory) {
    ...
    SVG.Element = SVG.invent({
      ...
      create: function create(node) {
        ...
        if (this.node = node) {
          ...
          this.node.instance = this; // location current attribute value
      ...
      extend: {
        ...
        */
        ...
        loop: function loop(times, reverse) {
          var c = this.last(); // location total loops
    ...
    SVG.extend(SVG.Element, {
      ...
      maskWith: function maskWith(element) {
        ...
        this.masker = element instanceof SVG.Mask ? element : this.parent().mask().add(element); // location reverence on self in mask
    ...
    SVG.extend(SVG.Element, {
      ...
      clipWith: function clipWith(element) {
        ...
        this.clipper = element instanceof SVG.ClipPath ? element : this.parent().clip().add(element); // location reverence on self in mask
    ...
    SVG.Gradient = SVG.invent({
      ...
      create: function create(type) {
        this.constructor.call(this, SVG.create(type + 'Gradient')); // location type
    ...
    SVG.Text = SVG.invent({
      ...
      create: function create() {
        ...
        this.dom.leading = new SVG.Number(1.3); // location leading value for rebuilding
      ...
      extend: {
        ...
        text: function text(_text) {
          ...
          if (typeof _text === 'function') {
            ...
            // location text and make sure text is not blank
            _text = _text.split('\n'); // build new lines
        ...
        rebuild: function rebuild(_rebuild) {
          // location new rebuild flag if given
  ...
  * Copyright (c) 2016 Wout Fierens; Licensed MIT */
  (function() {
    ...
    SVG.extend(SVG.Element, SVG.G, SVG.Nested, {
      // Create filter element in defs and location reference
      filter: function(block) {
    ...
    _createClass(ApexCharts, [{
      ...
      value: function setCurrentLocaleValues(localeName) {
        ...
        if (selectedLocale) {
          ...
          var ret = Utils.extend(en, selectedLocale); // location these locale options in global var for ease access
