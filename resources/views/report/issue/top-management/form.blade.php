                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('report.top-management.issue.form')}}">Issue Report Form</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Issue Report Form</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <form class="form" id="WorkExperienceForm" method="post" action="{{route('report.top-management.issue.form.result')}}">
                                        @csrf
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                               {{-- <div class="col-md-6 no-padding">
                                                ...
                                                <div class="col-md-6 no-padding">
                                                    <div class="form-group">
                                                        <label for="IssuedTo" class="text-bold-700">Issue To</label>
                                                        <select id="IssuedTo" class="select2 form-control" multiple="multiple" name="issued_to[]">
                                                            @if(!empty($issued_tos))
                                                                @foreach($issued_tos AS $media)
                                                                    <option value="{{$media->id}}" >{{$media->name}}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="col-md-3 no-padding">
                                                    <div class="form-group">
                                                        <label for="ReceiveFromDate" class="text-bold-700">From Issue Date</label>
                                                        <input type="date" id="ReceiveFromDate" class="form-control" name="issue_from_date">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 no-padding">
                                                    <div class="form-group">
                                                        <label for="ReceiveToDate" class="text-bold-700">To Issue Date</label>
                                                        <input type="date" id="ReceiveToDate" class="form-control" name="issue_to_date">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 no-padding">
                                                    <div class="form-group">
