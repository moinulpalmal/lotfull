                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.user.active')}}">Active Users</a>
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a href="{{route('admin.user.new')}}" title="Create New User"><i class="feather icon-navigation"></i></a></li>
                                    ...
                                    @if(!empty($users))
                                        ...
                                        @foreach($users as $media)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-info btn-sm btn-round fa fa-eye" href="{{route('admin.user.detail', ['id' => $media->id])}}" title="User Detail"></a>
                                                    @if(Auth::user()->hasTaskPermission('removeuser', Auth::user()->id))
                                                    <a class="btn btn-danger btn-sm btn-round fa fa-trash DeleteWorkExp" data-id="{{$media->id}}" title="Delete User"></a>
                                                    @endif
                                                    @if(Auth::user()->hasTaskPermission('updateuser', Auth::user()->id))
                                                        <a class="btn btn-warning btn-sm btn-round fa fa-edit" href="{{route('admin.user.edit', ['id' => $media->id])}}" title="Edit User"></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                    <h4 class="form-section text-left"><i class="feather icon-eye"></i> About Software User</h4>
...
@section('pageScripts')
    ...
    <script>
        ...
        $('#social-media-table').on('click',".DeleteWorkExp", function(){
            ...
            swal({
                title: 'Are you sure?',
                text: 'This record will be removed temporarily!',
                icon: 'warning',
                buttons: ["Cancel", "Yes!"],
            }).then(function(value) {
                if (value) {
