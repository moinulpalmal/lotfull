                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.user.new')}}"> New User</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card border-primary">
                        <div class="card-header">
                            <h4 class="card-title">New User Info Insert Form</h4>
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form class="form" id="ProfileForm" method="post"  enctype="multipart/form-data" action="{{route('admin.user.save')}}">
                                    @csrf
                                    <div class="form-body">
                                        @if (count($errors) > 0)
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 no-padding" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="EMPID" maxlength="4" class="form-control" placeholder="****" name="employee_id" required value="{{ old('employee_id')}}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                                                </div>
                                            </div>
                                            <div class="col-md-6 no-padding">
                                                <div class="form-group">
                                                    <label for="FullName" class="text-bold-700">User Full Name</label>
                                                    <input type="text" id="FullName" maxlength="250" class="form-control" placeholder="User Name" name="full_name" required value="{{ old('name')}}">
                                                </div>
                                            </div>
                                            <div class="col-md-3 no-padding">
                                                <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 no-padding">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" id="Email" maxlength="150" class="form-control" placeholder="xyz@gmail.com" name="email" required value="{{ old('email')}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 no-padding" >
                                                    <div class="form-group">
                                                        <label for="PMobile" class="text-bold-700">Personal Mobile No</label>
                                                        <input type="text" id="PMobile" maxlength="11" class="form-control" placeholder="018********" name="personal_mobile_number" required value="{{ old('personal_mobile_no')}}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 no-padding" >
                                                    <div class="form-group">
                                                        <label for="OMobile" class="text-bold-700">Official Mobile No</label>
                                                        <input type="text" id="OMobile" maxlength="11" class="form-control" placeholder="018********" name="official_mobile_number" required value="{{ old('official_mobile_no')}}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 no-padding" >
                                                    <div class="form-group">
                                                        <label for="OExt" class="text-bold-700">Official Extension No</label>
                                                        <input type="text" id="OExt" maxlength="4" class="form-control" placeholder="****" name="official_extension_number" required value="{{ old('official_extension_no')}}" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group" style="margin-top: 30px; margin-left: 20px; !important;">
                                                        <label class="checkbox-container text-bold-700" for="HasSlNo">Has Approval Authority?
                                                            <input type="checkbox" id="HasSlNo" name="approval_authority">
                                                ...
                                                <div class="col-md-5 no-padding">
                                                    <div class="form-group">
                                                        <label for="password" class="text-bold-700">Password</label>
                                                        <input type="password" id="password" maxlength="150" class="form-control" name="password" required  autocomplete="new-password">
                                                    </div>
                                                </div>
                                                <div class="col-md-5 no-padding">
                                                    <div class="form-group">
                                                        <label for="password-confirm" class="text-bold-700">Confirm Password</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <hr>
                                                    <img id="OPrimaryImage" src="" class="img-border img-thumbnail text-center">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions right">
                                        ...
                                        <button type="submit" class="btn btn-outline-primary">
                                            <i class="feather icon-check"></i> Save New User
                                        </button>
                                    </div>
                                </form>
                            </div>
