                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('admin.user.role')}}"> Roles</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 no-padding">
                                                <div class="form-group">
                                                    <label for="FactoryName" class="text-bold-700">Role Name</label>
                                                    <input type="text" class="form-control" name="name" id="FactoryName" placeholder="Enter factory name" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-3 no-padding">
                                                <div class="form-group">
                                                    <label for="ShortName" class="text-bold-700">Role View Name</label>
                            ...
                            <div class="card-body card-dashboard">
                                <table id="advanced-usage" class="table table-striped table-bordered table-condensed social-media table-info">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">Role View Name</th>
                                    ...
                                    @foreach($roles as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a data-id = "{{ $item->id }}" class="EditFactory btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
    ...
    <script>
        ...
        $(function(){
            ...
            $('#FactoryAdd').submit(function(e){
                ...
                var url = '{{ route('admin.user.role.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#advanced-usage').on('click',".EditFactory", function(){
            ...
            var url = '{{ route('admin.user.role.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: FactoryID},
