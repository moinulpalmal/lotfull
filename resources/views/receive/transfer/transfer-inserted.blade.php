                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('receive.list.transfer.inserted')}}">Transfer Detail List (Inserted)</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Transfer Detail List (Inserted)</h4>
    ...
    <script>
        ...
        function loadDataTable() {
            ...
            dataTable = $('.social-media').DataTable({
                ajax: {
                    url: "/lotfull/public/api/receive/list/transfer/inserted/{{ Auth::user()->id}}",
                    dataSrc: ""
                },
                columns: [
                    {
                                ...
                                if(parseInt(api_item.age) < 46){
                                    return "<p class='text-center'>" +
                                        ...
                                        @endif
                                            ...
                                            "<a title= 'Approve' class= 'btn btn-warning btn-sm btn-round fa fa-check ApproveWorkExp'data-id = "+ api_item.id +"></a>" +
                                        " &nbsp;" +
                                        @endif
                                            "</p>";
                                }
        ...
        $('#social-media-table').on('click',".ApproveWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('receive.list.transfer.approve') }}';
            swal({
                title: 'Are you sure?',
