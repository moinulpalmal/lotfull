<script>
    ...
    $(function(){
        ...
        $('#WorkExperienceForm').submit(function(e){
            ...
            var free_table = '<tr><td class="text-center" colspan="13">--- Please Wait... Loading Data  ---</td></tr>';
            $('tbody').html(free_table);

            var url = '{{ route('purchase.product.search.result') }}';
            //console.log(data);
            $.ajax({
                url: url,
                method:'POST',
                ...
                success:function(data){
                    ...
                    if(data === '0'){
                        //dataTable.destroy();
                        //console.log('0');
                        free_table = '<tr><td class="text-center" colspan="12">--- No Data Found ---</td></tr>';
                        $('tbody').html(free_table);
    ...
    function clearServiceMasterForm() {
        ...
        resetSelect2();
        dataTable.destroy();
        var free_table = '<tr><td class="text-center" colspan="12">--- No Data ----</td></tr>';
        $('tbody').html(free_table);
        has_data_table = false;
        resetSelect2();
    }
    ...
    $('#social-media-table').on('click',".PrintView", function(){
        ...
        var url = '{{ route('purchase.product.edit', ['id' =>  'pid']) }}';
