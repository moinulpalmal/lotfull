                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('issue.detail.issued')}}">Issued Detail List (Vendor)</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Issued Detail List (Vendor)</h4>
    ...
    <script>
        ...
        function loadDataTable() {
            ...
            dataTable = $('.social-media').DataTable({
                ajax: {
                    url: "/lotfull/public/api/issue/detail/issued/5000/{{ Auth::user()->id}}",
                    dataSrc: ""
                },
                columns: [
                    {
