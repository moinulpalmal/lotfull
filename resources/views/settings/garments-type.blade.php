                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{route('settings.garments-type.setup')}}">Garments Type List</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Garments Type Insert/Update Form</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="Degree" class="">Garments Type Name</label>
                                                        <input type="text" id="Degree" maxlength="150" class="form-control" placeholder="Enter Garments Type Name" name="name" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <section id="configuration">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Garments Type  List</h4>
                                <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
    ...
    <script>
        ...
        function loadDataTable() {
            ...
            dataTable = $('.social-media').DataTable({
                ajax: {
                    url: "/lotfull/public/api/settings/garments-type/setup/not-deleted-list",
                    dataSrc: ""
                },
                columns: [
                    {
        ...
        $(function(){
            ...
            $('#WorkExperienceForm').submit(function(e){
                ...
                var url = '{{ route('settings.garments-type.setup.save') }}';
                //console.log(data);
                $.ajax({
                    url: url,
                    method:'POST',
        ...
        $('#social-media-table').on('click',".DeleteWorkExp", function(){
            ...
            var url = '{{ route('settings.garments-type.setup.delete') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#social-media-table').on('click',".DeActivateWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('settings.garments-type.setup.de-activate') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#social-media-table').on('click',".ActivateWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('settings.garments-type.setup.activate') }}';
            swal({
                title: 'Are you sure?',
        ...
        $('#social-media-table').on('click',".EditWorkExp", function(){
            var button = $(this);
            var id = button.attr("data-id");
            var url = '{{ route('settings.garments-type.setup.edit') }}';
            $.ajax({
                url: url,
                method:'POST',
                data:{id: id, _token: '{{csrf_token()}}'},
